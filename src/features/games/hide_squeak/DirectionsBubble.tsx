...
export function DirectionsBubble({
  ...
  return (
    <div className="relative flex h-full items-end">
      <div
        className={['SpeechBubble mb-[80px] ml-auto mr-4.5', bubbleWrapperClassName]
          .filter(Boolean)
          .join(' ')}
      >
        <div
          className={[
            'relative min-h-[170px] min-w-[180px] w-fit rounded-[20px] bg-hs-panel px-4 pb-6 pt-5 shadow-hs-panel',
            bubbleClassName,
          ]
            .filter(Boolean)
            .join(' ')}
